...
if (isNautilus):
  compile_source(filename="nmgc.f90", extra=["opkda1.f90", "opkda2.f90", "opkdmain.f90"])

if (isOutputs):
  compile_source(filename="nmgc_outputs.f90")

if (isOutputs_select):
    compile_source(filename="nmgc_select_outputs.f90")

if (isRates):
  compile_source(filename="nmgc_rates.f90")

if (isMajor):
  compile_source(filename="nmgc_major_reactions.f90")
  
if (isTrace):
  compile_source(filename="nmgc_trace_major.f90")
