...
MNAUTILUS_PATH = os.path.dirname(os.path.realpath(sys.argv[0]))

MNAUTILUS_ADDON = """# %s DO NOT EDIT !
#########################################
...
source $nmgc/.mnautilus_profile

#########################################
# %s DO NOT EDIT !""" % (BEGIN_MARK, MNAUTILUS_PATH, END_MARK)
...
object_file.write(MNAUTILUS_ADDON)
